...
class OFTRequest(
    ...
    oft_int_id: int
    oft_path: str = ""
    oft_local_path: str | None = msgspec.field(default=None)
    long_oft_max_len: int | None = None
    ...
    def __eq__(self, value: object) -> bool:
        ...
        """
        return isinstance(value, self.__class__) and self.oft_name == value.oft_name
