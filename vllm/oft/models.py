...
from vllm.oft.layers import BaseLayerWithOFT, FusedMoEWithOFT, OFTMapping
...
class OFTModel:
    ...
    def __init__(
        ...
        assert oft_model_id > 0, (
            f"a valid oft id should be greater than 0, got {self.id}"
        )
    ...
    def get_oft(self, module_name: str) -> OFTLayerWeights | None:
...
class OFTModelManager:
    ...
    def pin_adapter(self, lora_id: int) -> bool:
        ...
        raise NotImplementedError(
            ...
            "Use LRUCacheOFTModelManager for pinning"
        )  # type: ignore
    ...
    def _create_lora_modules(self):
        ...
        for module_name, module in self.model.named_modules(remove_duplicate=False):
            ...
            if self.supports_mm and not isinstance(new_module, BaseLayerWithOFT):
                continue
    ...
    def register_module(self, module_name: str, module: "BaseLayerWithOFT"):
        assert isinstance(module, BaseLayerWithOFT), (
            f"Module {module_name} must be a BaseLayerWithOFT instance,"
        )
        f" got {type(module)}"
    ...
    def get_adapter(self, adapter_id: int) -> OFTModel | None:
